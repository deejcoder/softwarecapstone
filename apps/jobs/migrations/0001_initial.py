    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', ckeditor.fields.RichTextField(max_length=3500)),
                ...
                ('date_posted', models.DateTimeField(default=datetime.datetime(2018, 10, 31, 7, 57, 20, 451093, tzinfo=utc))),
                ('expiry', models.DateTimeField(default=datetime.datetime(2018, 11, 14, 7, 57, 20, 451093, tzinfo=utc))),
